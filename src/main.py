...
def chat():
    ...
    messages = [
        {'role': "system", "content": "You are an AI assistant for FARM-FRIEND AI, an innovative platform that leverages artificial intelligence to enhance agricultural practices. Provide helpful and accurate information about FARM-FRIEND AI's services and agricultural technology."},
